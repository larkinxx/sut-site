...
<p>Сайт ведёт редакция «Сути». Новости готовятся автоматически по строгим правилам, важные новости перед публикацией проверяет редакция. Подробно об этом — на странице <a href="${url('/kak-my-rabotaem/')}">«Как мы работаем»</a>.</p>
